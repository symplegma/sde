 ...
 * @author pchr
 */
public class sdeConsole extends javax.swing.JTextArea{
    // from ReadlinePanel of Artisynth
   ...
   public void setInterpreter(sdeShell theInterpreter){
   ...
   public static class OutputWriter extends Writer {
      ...
      sdeConsole myConsole;

      public OutputWriter (sdeConsole console) {
         myConsole = console;
      }
         ...
         if (metaState == NORMAL) {
            switch (code) {
               ...
               case KeyEvent.VK_ENTER: {
                  theInterpreter.eval(getLineText());
                  break;
               }
            }
         }
...
//
//      sdeConsole console = new sdeConsole();
